...
import com.example.league.FileHelper;
...
public class PremierLeagueServiceTest {
    ...
    @Test
    public void calculateRank_input_from_file_test() throws Exception {

        List<String> input = fileHelper.readFromFile("input/inputFile.txt");


        List<String> expectedOutput = fileHelper.readFromFile("output/outputFile.txt");
